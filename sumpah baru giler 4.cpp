...
if (selectedItem != nullptr) {
    ...
    switch (selectedItem->getId()) {
        case 1:
            ...
            cout << monsterName <<"'s health decrease by 9"<<endl;
        ...
        case 1:
            {
                ...
                // Display goblin details
   				 Monster* monster = new Monster("Goblin", 1, 150);
        ...
        case 1:
            {
                cout << "Continuing to the game..." << endl;
                // Display goblin details
   				 Monster* monster = new Monster("Zombie", 2, 200);
        ...
        case 1:
            {
                cout << "Continuing to the game..." << endl;
                // Display goblin details
   				 Monster* monster = new Monster("White Dragon", 3, 350);
        		...
        		switch (choice) {
            		case 1:
                 		attackMonster(monster);
                		if (monster->getHealth() <= 0) {
                    		cout << "You defeated the White Dragon!" << endl;
                    		cout << "You have completed this game. Congratulations!" <<endl;
                    		exit(0);
                		}
                		break;
            		case 2:
